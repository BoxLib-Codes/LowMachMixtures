...
module analyze_spectra_module
  ...
  use probin_common_module, only: n_cells, prob_lo, prob_hi, &
       project_dir, max_grid_projection, stats_int, &
       center_snapshots, analyze_conserved

  implicit none

  private
  public :: initialize_hydro_grid, finalize_hydro_grid, print_stats
...
contains   
  ...
  subroutine initialize_hydro_grid(mla,s_in,dt,dx, &
  ...
  end subroutine initialize_hydro_grid
